...
export class Game {
    ...
    async createScene() {
        ...
        //Create the No. 1 physics airplane
    ...
    /**
     * Start, temporary physical effects
     */
    ...
    /**
     * One of the planes in the driving scene
     * @param index 
     * @returns 
     */
