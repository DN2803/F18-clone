...
export class F18Explode {
    ...
    /**
     * Create each exploded particle according to the box
     * @param mesh 
     * @param size 
     * @param position 
     * @param rotation 
    ...
    private createBox(mesh: BABYLON.Mesh, size, position, rotation, mass) {
        ...
        //If the bounding box cannot be obtained, it will be discarded.
    ...
    /**
     * Wake up the physical rigid body effect and explode it
     * @param index 
     */
    physicsStart(index) {
