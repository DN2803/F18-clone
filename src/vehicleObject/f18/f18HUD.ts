...
export class F18HUD {
    ...
    /**
     * @description: Create an airplane first person gui
     * @param {*}
     * @return {*}
     */
    ...
    /**
     * @description: Create a collection of elevation angles gui
    ...
    /**
     * @description: Create offset angle number collection gui
     * @param {*} rollRectGui
     * @return {*}
     */
    ...
    */
    ...
    updateFlyData() {
        if (this.xmlLoader.getNodeById("flySpeed")) {
            ...
            if (this.vehicle.undercarriageState) {
                this.xmlLoader.getNodeById("undercarriageState").text = "Landing gear: open"
            } else {
                this.xmlLoader.getNodeById("undercarriageState").text = "Landing gear: retracted"
            }
        }
    }
    ...
    /**
     * Show HUD
     * @param state Whether to display
     */
