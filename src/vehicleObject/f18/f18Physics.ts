...
export class F18Physics {
    ...
    public render(): void {
        ...
        if (this.vehicleReady) {
            ...
            //Aircraft HUD update parameters
            ...
            //First person camera perspective easing animation
            ...
            //Tire position and rotation information
            let tm, p, q, i;
            ...
            //Car body position and rotation
        ...
        //Lift force at different speeds
    ...
    private createVehicle() {
        //Going Native Create a physical world
        ...
        //Car body composite shape combination
